...
const MEDIA_URL = "https://media.retroachievements.org";
const SITE_URL = "https://retroachievements.org";

// --- Helper Functions ---
const formatTimeAgo = (dateStr, refDateStr) => {
...
const transformData = (data) => {
  ...
  // 2. Overwrite / Merge with Completion Progress (To capture Mastered/Beaten Flags and explicit progress)
  ...
  gameMap.forEach((game, gameId) => {
    ...
    if (details) {
        ...
        // Subset detection — parentGameId is the canonical signal
        ...
        if (details.achievements && Object.keys(details.achievements).length > 0) {
            ...
            // Fallback: If progress didn't set achievementsTotal, use details (catches 0% progress games)
  ...
  // --- Extrapolated Stats Calculations ---
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-5">
          ...
          <div className="flex-1 flex flex-col gap-1.5 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-1.5 mt-0.5">
              <span className="text-[9px] font-semibold uppercase tracking-[0.07em] px-2 py-[3px] rounded-[2px] border border-[#323f4c] bg-[#101214] text-[#8f98a0]">
                {PROFILE_DATA.totalPoints.toLocaleString()} pts
              </span>
              <span className="text-[9px] font-semibold uppercase tracking-[0.07em] px-2 py-[3px] rounded-[2px] border border-[#323f4c] bg-[#101214] text-[#8f98a0]">
                {PROFILE_DATA.totalUnlocked.toLocaleString()} achievements
              </span>
              <span className="text-[9px] font-semibold uppercase tracking-[0.07em] px-2 py-[3px] rounded-[2px] border border-[#323f4c] bg-[#101214] text-[#8f98a0]">
